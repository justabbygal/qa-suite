 ...
 *
 * Allowed formats: JPEG, PNG, WebP (not GIF). Max size: 5 MB.
 */
...
export const UPLOAD_PROGRESS_THRESHOLD_BYTES = 1 * 1024 * 1024;

export type ImageValidationErrorCode = 'MISSING_FILE' | 'INVALID_TYPE' | 'FILE_TOO_LARGE';
...
/** Returns true when a file of this size should show a progress indicator. */
 ...
 * and the raw buffer length. This is a backup check.
 *
 * @param buffer      - Raw image bytes from the incoming request.
 * @param contentType - MIME type for the part.
 */
