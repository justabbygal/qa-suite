...
export interface PermissionToggleProps {
  ...
  disabled?: boolean;
  /**
   * When true, an API save is in-flight for this toggle. The button is
   * disabled and a pulsing animation signals the pending state to the user.
   * Screen readers are informed via `aria-busy`.
   */
  pending?: boolean;
